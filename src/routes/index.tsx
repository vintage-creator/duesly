  ...
  head: () => ({
    meta: [
      { title: "Duesly — Trusted Dues, Levies & Reconciliation" },
      {
        name: "description",
        content:
          "Virtual-account-powered collections for markets, estates, cooperatives & trade groups. Auto reconciliation, receipts, and reports — built for serious associations.",
      },
      { property: "og:title", content: "Duesly — Trusted Collections for Associations" },
      {
        property: "og:description",
        content:
          "Issue unique virtual accounts to every vendor or member. Reconcile every naira automatically.",
      },
    ],
  }),
  component: Landing,
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="text-white">
              ...
              <p className="mt-5 max-w-xl text-base text-white/80 sm:text-lg">
                Duesly helps markets, estates, cooperatives and trade groups collect payments
                through dedicated virtual accounts, then reconcile dues, issue receipts and produce
              ...
              <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-white/70">
                ...
                <span className="inline-flex items-center gap-2">
                  <Check className="h-4 w-4 text-emerald" /> No setup fee
                </span>
                <span className="inline-flex items-center gap-2">
                  <Check className="h-4 w-4 text-emerald" /> Cancel anytime
                </span>
              </div>
            </div>
              ...
              <div className="relative rounded-3xl border border-white/20 bg-white/95 p-5 shadow-elevated backdrop-blur">
                ...
                <div className="mt-4 rounded-2xl bg-gradient-hero p-5 text-white shadow-soft">
                  ...
                  <p className="mt-2 text-xs text-white/75">
                    79% of {formatNaira(22_464_000)} expected
                  </p>
                </div>
                <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                  ...
                  <div className="rounded-xl bg-warning/15 p-3">
                    <p className="font-display text-lg font-bold text-[color:var(--warning-foreground)]">
                      264
                    </p>
                ...
                <div className="mt-4 space-y-2">
                  {[
                    ...
                    >
                      ...
                      <span
                        className={`text-sm font-semibold ${p.ok ? "text-emerald" : "text-[color:var(--warning-foreground)]"}`}
                      >
                        {p.amt}
                      </span>
                    </div>
      ...
      <section className="border-y border-border/60 bg-secondary/40 py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs font-medium uppercase tracking-wider text-muted-foreground">
            Trusted by associations across Nigeria
          </p>
          <div className="mt-5 grid grid-cols-2 gap-4 text-center sm:grid-cols-4 lg:grid-cols-5">
            {[
              ...
              <div key={n} className="font-display text-sm font-semibold text-muted-foreground/80">
                {n}
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold text-navy sm:text-4xl">
              Everything you need to collect, match and report.
            </h2>
            <p className="mt-4 text-muted-foreground">
              Built specifically for the realities of market unions, estates and cooperatives — not
              generic invoicing.
            </p>
          </div>
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                i: Wallet,
                t: "Unique Virtual Accounts",
                d: "Every vendor or member gets a dedicated NUBAN they can fund from any bank, anywhere.",
                c: "emerald",
              },
              {
                i: RefreshCcw,
                t: "Auto Reconciliation",
                d: "Incoming payments match instantly to the right vendor, dues category and period.",
                c: "navy",
              },
              {
                i: AlertCircle,
                t: "Over & Underpayments",
                d: "Smart handling for partial payments, overpayments and credits without spreadsheets.",
                c: "gold",
              },
              {
                i: Receipt,
                t: "Instant Receipts",
                d: "Branded receipts issued and shared automatically — by SMS, WhatsApp or download.",
                c: "emerald",
              },
              {
                i: FileBarChart2,
                t: "Reports & Exports",
                d: "Compliance, collection and category reports. Export to CSV or PDF in one click.",
                c: "navy",
              },
              {
                i: ShieldCheck,
                t: "Audit-Ready Ledger",
                d: "Every kobo accounted for, with a full trail your auditors and members can trust.",
                c: "gold",
              },
            ].map((f) => (
              <div
              ...
              >
                <div
                  className={`grid h-12 w-12 place-items-center rounded-xl ${f.c === "emerald" ? "bg-gradient-emerald text-white shadow-emerald" : f.c === "gold" ? "bg-gradient-gold text-[color:var(--gold-foreground)]" : "bg-navy text-white"}`}
                >
      ...
      >
        <div className="absolute inset-0 opacity-30">
          <svg viewBox="0 0 800 400" className="h-full w-full" preserveAspectRatio="none">
            ...
            <path
              d="M0,200 Q200,80 400,200 T800,200"
              stroke="url(#g1)"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M0,260 Q200,140 400,260 T800,260"
              stroke="url(#g1)"
              strokeWidth="2"
              fill="none"
            />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <span className="inline-flex rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-emerald">
              Built for
            </span>
            <h2 className="mt-3 font-display text-3xl font-bold sm:text-4xl">
              A platform that fits the way your group already collects.
            </h2>
          </div>
            ...
            {[
              {
                i: Store,
                t: "Markets",
                d: "Daily, weekly and monthly levies across thousands of shops and lines.",
              },
              {
                i: Building,
                t: "Estates",
                d: "Service charge, security and sanitation dues for residents and tenants.",
              },
              {
                i: Handshake,
                t: "Cooperatives",
                d: "Member contributions, savings and loan repayments handled centrally.",
              },
              {
                i: Users,
                t: "Trade Associations",
                d: "Annual fees, conventions and special levies across chapters.",
              },
            ].map((u) => (
              <div
                key={u.t}
                className="rounded-2xl border border-white/15 bg-white/5 p-6 backdrop-blur-sm transition-all hover:bg-white/10"
              >
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button variant="navy" asChild>
                  <Link to="/dashboard">Open admin demo</Link>
                </Button>
                <Button variant="outline" asChild>
                  <Link to="/vendor-portal">View vendor portal</Link>
                </Button>
              </div>
            </div>
              ...
              <div className="rounded-2xl bg-card p-4">
                ...
                <div className="mt-4 h-32 rounded-xl bg-gradient-to-br from-navy to-emerald/80 p-4">
                  ...
                  <svg viewBox="0 0 200 60" className="mt-2 h-16 w-full">
                    <polyline
                      points="0,45 30,38 60,30 90,32 120,22 150,18 180,12 200,8"
                      fill="none"
                      stroke="white"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                    ...
                    />
                    <polyline
                      points="0,50 30,46 60,42 90,40 120,34 150,30 180,26 200,22"
                      fill="none"
                      stroke="var(--gold)"
                      strokeWidth="2"
                      strokeLinecap="round"
      ...
      <section id="pricing" className="px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-gradient-hero p-10 text-center text-white shadow-elevated sm:p-14">
          <h2 className="font-display text-3xl font-bold sm:text-4xl">
            Ready to clean up your collections?
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-white/80">
            Onboard your association in under 24 hours. No long contracts, no setup fees.
          </p>
      ...
      <footer className="border-t border-border bg-secondary/40">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Duesly. Built for trusted collections.
          </p>
